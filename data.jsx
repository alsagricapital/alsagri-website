...
const SERVICES = [
  {
    id: 'earnings',
    num: '01',
    ar: 'تقارير ومكالمات نتائج الشركات',
    en: 'Earnings Call Reports',
    desc: 'ملخصات وتحليلات لمكالمات نتائج الشركات السعودية المدرجة، تشمل تعليقات الإدارة، أبرز المؤشرات المالية، ورؤى موجَّهة للمستثمرين.',
...
const REPORTS = [
  // ── Earnings calls ─────────────────────────────────────────────
  {
    ...
    co: 'أرامكو السعودية',
    ticker: '2222.SR',
    title: 'ملخص مكالمة نتائج الربع الثالث 2025',
    desc: 'استعراض أبرز ملاحظات الإدارة حول مستويات الإنتاج، التدفقات النقدية الحرة، وسياسة التوزيعات النقدية.',
    metrics: ['FCF', 'CAPEX', 'Dividend'],
    date: '2025·11·04',
    spark: [22,24,21,26,28,27,31,29,33,35,34,38],
  },
  {
    cat: 'earnings',
    co: 'البنك الأهلي السعودي',
    ticker: '1180.SR',
    title: 'مكالمة نتائج النصف الأول — هوامش وجودة محفظة',
    desc: 'تحليل لتطور صافي هامش الفائدة، تكلفة المخاطر، ونمو القروض الاستهلاكية والشركاتية.',
    metrics: ['NIM', 'CoR', 'Loan Growth'],
    date: '2025·08·11',
    spark: [18,19,17,20,22,21,23,22,25,24,26,28],
  },
  {
    cat: 'earnings',
    co: 'المراعي',
    ticker: '2280.SR',
    title: 'نتائج الربع الثاني — ضغوط المدخلات وإطلاق فئات جديدة',
    desc: 'مناقشة هوامش الربحية، تكاليف الأعلاف، وأداء قطاعَي الألبان والمخبوزات في السوق المحلية والتصدير.',
    metrics: ['Gross Margin', 'Volume', 'ASP'],
    date: '2025·07·28',
    spark: [30,28,27,29,25,26,24,25,27,28,30,32],
  },
  // ── Brokerage / research ───────────────────────────────────────
  {
    cat: 'brokerage',
...
const TICKER_STATS = [
  { k: 'REPORTS PUBLISHED',  v: '120', unit: '+' },
  { k: 'COMPANIES COVERED',  v: '40',  unit: '+' },
  { k: 'SECTORS',            v: '11',  unit: '/ TASI' },
  { k: 'AVG. READ TIME',     v: '6',   unit: 'min' },
];
